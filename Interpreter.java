...
public class Interpreter {
    ...
    public void execute(String program, Graphics g) {
        ...
        while (r.hasMoreTokens()) {
            ...
            } else if (t.getSymbol().charAt(0).equals('/')) {
            	
            	operands.push(t.subString(1),t.length);
    ...
    public void execute_def() {
    	 pair defined = new pair(operands.push(),operands.push());
    }
    
    public void execute_set() {
    	
    }
    
    public void execute_undef() {
